...
hamburger.addEventListener("onmouseenter", hamburger_symbol);

function hamburger_symbol() {
  let dropItems = document.querySelectorAll(".hamburgerMenu span");

  dropItems.forEach((e) => (e.style.backgroundColor = "green"));
}
